...
Rails.application.configure do
  ...
  # Mailtrap API Configuration for Development (Sandbox)
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.perform_deliveries = true
  config.action_mailer.delivery_method = :mailtrap
  
  # Set Mailtrap settings directly on ActionMailer::Base after initialization
...
# }
  ...
  #   port: 587,
  #   domain: "gmail.com",
  #   user_name: "efuelight12",
  #   password: "vedhjczewggzvbwq",
